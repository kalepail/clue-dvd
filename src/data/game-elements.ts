...
export const MYSTERY_THEMES: MysteryTheme[] = [
  {
    ...
    name: "AI Mystery",
    period: "1925-1926",
    description: "A bespoke evening at Tudor Mansion, generated for each investigation",
    typicalLockedRooms: [],
    atmosphericElements: ["candlelit conversations", "hushed intrigue", "garden whispers"],
  },
  {
    id: "DEV01",
